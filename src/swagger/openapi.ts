...
export const swaggerDocument = {
  ...
  info: {
    ...
    version: "1.0.0",
    description:
      "Inventory API with JWT authentication, admin-managed account registration, category-filtered items, and action-filtered audit logs.",
  },
  servers: [
    {
  ...
  paths: {
    ...
    "/api/users": {
      get: {
        ...
        description: "Returns paginated user entries containing only ID, username, and role.",
        security: [{ bearerAuth: [] }],
        parameters: [
